...
namespace ProyectoFinal_PrograIII.Controladores
{
    ...
    {
       private readonly ProyectoFinal_PrograIII.ApiECommerce.IServices.IClienteService _clienteService;

    public ClientesController(ProyectoFinal_PrograIII.ApiECommerce.IServices.IClienteService clienteService)
        {
